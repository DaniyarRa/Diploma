...
def main_view(request):
    ...
    if request.method == 'POST' and form.is_valid():
        step = int(form.cleaned_data['Step'])
    ...
    return render(request, 'main_page.html', {'form': form, 'data': data_new2, 'step': step_dict[step] or 0.01, 'google_map_api_key': settings.GOOGLE_MAP_API_KEY})
